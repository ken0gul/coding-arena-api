...
app.use(function(req, res, next) {
  res.header("Access-Control-Allow-Origin", "https://coding-arena-production.up.railway.app:6146"); // Replace "*" with the specific origin you want to allow, or use "*" to allow any origin
